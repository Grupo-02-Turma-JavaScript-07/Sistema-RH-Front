...
function Perfil({ idColaborador }: PerfilProps) {
  ...
  return (
    <div className="flex">
      ...
      <div
        className={`flex-1 flex flex-col justify-center w-full my-4 transition-all duration-300
          ${sidebarMinimizada ? 'ml-20' : 'ml-72'} max-md:ml-0`}
      >
        <div className="w-full pt-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-4 md:px-8">
            ...
            <div className="relative group">
              ...
              <div
                className="absolute left-[-250px] mt-2 w-[80vw] sm:w-[20vw] bg-white border rounded-lg shadow-lg 
        ...
        <div className="px-4 md:px-8 py-5 text-center md:text-start">
          <h3 className="font-marko text-4xl">Olá,</h3>
          <p>{colaborador?.nome}</p>
        </div>

        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 px-4 md:px-8 my-5">
          <img
            src={colaborador?.foto}
            alt="Imagem avatar"
        ...
        <h3 className="font-marko text-2xl px-4 md:px-8">Ações rápidas</h3>
        <div className="flex flex-col md:flex-row justify-start gap-5 px-4 md:px-8">
          <div className="flex-1 my-5 p-4 border border-gray-200 rounded-xl shadow-sm max-w-md">
            ...
            <p className="mt-2 font-zain text-2xl text-gray-600">
              Peça permissões adicionais ou acesso a outras áreas.
            </p>
          </div>
          <div className="flex-1 my-5 p-4 border border-gray-200 rounded-xl shadow-sm max-w-md">
            <Password size={20} />
            ...
            <p className="mt-2 font-zain text-2xl text-gray-600">
              Mantenha sua conta segura trocando sua senha regularmente.
            </p>
          </div>
        </div>
      </div>
